...
public class TheWorldOverHavenStandModel extends HumanoidStandModel<TheWorldOverHavenStandEntity> {
...
//            .startFaceCalcNormal()
    ...
    protected void initActionPoses() { // TODO pickaxe throwing anim
        actionAnim.put(StandPose.RANGED_ATTACK, new PosedActionAnimation.Builder<TheWorldOverHavenStandEntity>()
    ...
    @Override
    public void prepareMobModel(TheWorldOverHavenStandEntity entity, float walkAnimPos, float walkAnimSpeed, float partialTick) {
    ...
    protected ModelPose<TheWorldOverHavenStandEntity> initIdlePose() {
        return super.initIdlePose();
    }

    @Override
    protected IModelPose<TheWorldOverHavenStandEntity> initIdlePose2Loop() {
